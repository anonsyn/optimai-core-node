  ...
  return (
    <Popover open={debouncedOpen} onOpenChange={setOpen}>
      <PopoverTrigger asChild onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <button
          type="button"
          className="hover:bg-accent/40 focus-visible:ring-primary text-13 focus-visible:ring-offset-background bg-accent/30 flex items-center gap-2 rounded-xl border border-white/5 px-4 py-2 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
        >
