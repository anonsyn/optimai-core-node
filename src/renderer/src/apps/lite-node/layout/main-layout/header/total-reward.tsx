  ...
  return (
    <div className="flex min-h-16 flex-1 flex-col justify-between rounded-md border border-white/2 bg-white/4 px-2 py-1.5">
      <div className="flex w-full items-center justify-between">
        <p className="text-12 font-normal text-white/80">Total Rewards</p>
        <TooltipProvider delayDuration={300}>
          <Tooltip>
            ...
            <TooltipContent className="bg-background max-w-[200px]">
              <p className="text-12 text-balance">
                All-time rewards from your nodes and network contributions
              </p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="flex h-6 items-center">
          ...
          >
            <NumberFlow value={reward || 0} trend="increasing" format={balanceFormatOptions} />
          </p>
        </div>
      </div>
    </div>
