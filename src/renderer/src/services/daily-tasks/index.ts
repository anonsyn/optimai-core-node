...
export const dailyTaskService = {
  ...
  getCheckInHistory() {
    return axiosClient.get<GetCheckInHistoryResponse>(
      "/daily-tasks/check-in-history"
    );
  },
  ...
  hasClaimedCheckInWeeklyReward() {
    return axiosClient.get<HasClaimedWeeklyRewardResponse>(
      "/daily-tasks/has-claimed-weekly-reward"
    );
  },
};
